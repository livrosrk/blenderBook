...
\title{Learning the Basics of Blender for no Reason}
\author{Robin Kohrs}
\date{2021-12-04}
...
\hypersetup{
  pdftitle={Learning the Basics of Blender for no Reason},
...
\NormalTok{\textless{}!{-}{-}chapter}\InformationTok{:end:01{-}Modelling}\FunctionTok{.Rmd{-}{-}\textgreater{}}
\end{Highlighting}
\end{Shaded}
